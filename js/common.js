...
jQuery.fn.serializeAnythingLbs = function(addData) {
    var toReturn    = [];
...
function toeListableLbs(params) {
	...
	this.draw = function(list, count) {
		this.table.find('tr').not('.lbsExample, .lbsTblHeader').remove();
		var exampleRow = this.table.find('.lbsExample');
		for(var i in list) {
			...
			newRow.removeClass('lbsExample').show();
...
function setCookieLbs(c_name, value, exdays) {
	var exdate = new Date();
