<?php
class supsystic_promoModelLbs extends modelLbs {
	private $_apiUrl = '';
	...
	public function saveUsageStat($code) {
		$query = 'INSERT INTO @__usage_stat SET code = "'. dbLbs::escape($code). '", visits = 1
			ON DUPLICATE KEY UPDATE visits = visits + 1';
		return dbLbs::query($query);
	}
	...
	public function getUserStatsCount() {
		...
		return (int) dbLbs::get($query, 'one');
	}
