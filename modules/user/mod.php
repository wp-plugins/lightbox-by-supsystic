<?php
class userLbs extends moduleLbs {
    ...
    public function isAdmin() {
        ...
        return current_user_can( frameLbs::_()->getModule('adminmenu')->getMainCap() );
    }
	...
	protected function _loadUserData() {
		if(!$this->_dataLoaded) {
			if(!function_exists('wp_get_current_user')) frameLbs::_()->loadPlugins();
	...
	public function getAdminsList() {
		global $wpdb;
		$admins = dbLbs::get('SELECT * FROM #__users
